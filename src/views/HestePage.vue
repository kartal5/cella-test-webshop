...
export default {
  ...
  setup() {
    ...
    // Get all subcategories for 'heste'
    const subcategories = getSubcategoriesByCategory('heste');
    ...
    // Method to get products by subcategory for 'heste' category
    const getProductsBySubcategory = (subcategory) => {
      return getProductsByCategoryAndSubcategory('heste', subcategory);
    };
