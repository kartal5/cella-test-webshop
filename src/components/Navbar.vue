<template>
  <nav class="flex flex-col sm:flex-row sm:justify-between sm:items-center bg-dark-brown p-4">

    <div id="user-nav" class="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2">
      <template v-if="isAuthenticated">
        <span class="hidden sm:inline text-base text-gray-300 font-light">Velkommen, {{ userEmail }}</span>
        ...
        <router-link
          to="/admin/orders"
          class="text-base text-white hover:text-light-brown"
        >
          Ordreoversigt
        </router-link>
    ...
    <div id="some-links" class="flex justify-center space-x-4 mt-4 sm:mt-0">
