...
Ingrediensliste: Byggræs (Hordeum vulgare L.), tørret ekstrakt af fermenteret byggræs (Hordeum vulgare L.), fermenteret brændenælde (Urtica dioica L.), Zygosaccharomyses rouxii, Lactobacillus delbrueckii, hydroxypropylmethylcellulose (vegetabilsk kapsel).`,
  ...
  Ingrediensliste: Chaga ekstrakt (Inonotus obliquus (Ach. ex Pers.) Pilát), inulin fra cikorierod, tørret ekstrakt af fermenteret byggræs (Hordeum vulgare L.), fermenteret brændenælde (Urtica dioica L.), Zygosaccharomyses rouxii, Lactobacillus delbrueckii, hydroxypropylmethylcellulose (vegetabilsk kapsel).`,
      price: 'DKK 250.00',
...
Ingredienser: Risstivelse, Maltodextrin (ikke gensplejset majs), Mineralblanding (mangan, kalium, magnesium), Enzymer (Amylase), 8 bakteriestammer: B.bifidum, B.breve, B.infantis, B.lactis, L.brevis, L.casei, L.paracasei, L.lactis. 15 milliarder cfu pr. dosis.
...
Anbefalet daglig tilførsel: 1 tsk. i vand, vent 15 min. Bedst på tom mave.`,
  ...
  },
  {
      ...
      fullDescription: `Bemer International AG er førende indenfor mikrocirkulation. Bemer-terapi forbedrer blodcirkulationen i kroppen, øger tilførsel af ilt og næringsstoffer, og fremskynder helingsprocessen.
...
Ingredienser: Majsstivelse (ikke gensplejset majs), Maltodextrin (ikke gensplejset majs), Mineralblanding (mangan, kalium, magnesium), FOS, Inulin, Enzymer (Amylase), 4 bakteriestammer: B.breve M/13, B.bifidum, B.infantis, B.lactis. 20 milliarder cfu pr. dosis.
